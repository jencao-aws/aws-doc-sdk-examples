...
CLASS ltc_awsex_cl_ec2_actions IMPLEMENTATION.
  ...
  METHOD instance_lifecycle.
    " This test covers: start_instance, stop_instance, reboot_instance, monitor_instance
    " associate_address, disassociate_address, create_vpc_endpoint, delete_vpc_endpoints
    " All in one test to reduce instance creation overhead
    ...
    cl_abap_unit_assert=>assert_equals( act = lv_status exp = 'stopped' msg = |Instance should be stopped| ).
